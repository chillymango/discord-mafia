"""
Try out different strings here and see what gives us the best Mafia gameplay...
"""


TEST_INVEST = """Your goal is to eliminate all members of the Mafia and all Neutral Evil characters. You lose if all members of the Town are eliminated.

This concerns the rules of your interaction.

You are an Investigator. The Investigator is a member of the Town who can check a person for their crime record each night.
